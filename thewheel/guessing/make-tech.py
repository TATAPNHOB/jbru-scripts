...
first = True
cluemode = False
t_o = {"altSpellings":[],"answer":"","category":"","clues":[],"followup":None,"id":"","intro":None,"isValid":"","outro":None,"prompt":"","reveal":None,"us":False,"x":False}
content = []
...
for line in lines:
    ...
    if s[0] == 'id':
        ...
        t["reveal"] = s[2]
    elif s[0] == 'outro' and s[2] != '<отсутствует>':
        t["outro"] = s[2]
    elif s[0] == 'intro' and s[2] != '<отсутствует>':
        t["intro"] = s[2]
...
t["clues"] = clues
content += [t]
n = open('TheWheelGuessingTech.jet','w',encoding='utf-8')
